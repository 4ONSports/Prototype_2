...
namespace Online
{
	...
	{
		public string apiKey = "a548e1b567249923bcba5c96a94341fdeed1ecbb11f115f8b52c41e68a2b4cd8"; //"<Your_API_KEY>";						// API key that you have receieved after the success of app creation from AppHQ
		public string secretKey = "d75b2d992ab2820ae3616f35e6a16e25506cc039667d4f8d1d906d52a2b43187"; //"<Your_SECRET_KEY>";					// SECRET key that you have receieved after the success of app creation from AppHQ
		public string roomID = "";//"<Your_Room_ID>";
		...
		public string channelName  = "Test_Channel";//"<Enter_the_channel_name>"; 		// Enter your ChannelName which you have to subscribe for PushNotification		
